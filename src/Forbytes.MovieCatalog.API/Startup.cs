...
using Forbytes.MovieCatalog.API.Infrastructure;
...
namespace Forbytes.MovieCatalog.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Forbytes.MovieCatalog.API", Version = "v1" });
            });

            services.Configure<DatabaseSettings>(Configuration.GetSection("MovieCatalogDatabaseSettings"));
        }
